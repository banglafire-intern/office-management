export const routes = [{
        ...
        path: "/chat",
        name: "Chat",
        component: () => import("./components/employee/chat/chat.vue"),
    },
    {
        /* Admin */
        path: "/admin/home",
        ...
        component: () => import("./components/admin/employee_profile/employee_profile.vue"),
    }, {
        /* Admin */
        path: "/admin/leave-management",
        name: "AdminLeaveManagement",
        component: () => import("./components/admin/leave_management/leave_management.vue"),
    },
    {
        /* Admin */
        path: "/admin/chat",
